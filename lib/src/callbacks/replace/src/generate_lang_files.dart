...
Future<void> generateLangFiles(String path, Map<String, String> redefinedMap, List<String> langs, String mainLang, String fileFormat) async {
  ...
  await Future.forEach(langs, (lang) async {
    ...
    for (var mEntry in redefinedMap.entries) {
      MapEntry<String, String> mappedEntry =
          MapEntry('"' + cleanContent(mEntry.value.trim()).replaceAll('"', "'") + '"', lang == mainLang ? ('"' + cleanContent(mEntry.key.trim()) + '"').replaceAll('\n', '\\n') : '""');
