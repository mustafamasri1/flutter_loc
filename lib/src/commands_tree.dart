  ...
  DartedCommand(
    ...
    flags: [
      ...
      DartedFlag(
          ...
          describtion:
              'run the extraction with the logging enabled to see the match stats without doing the extraction.'),
      DartedFlag(
          name: 'overwrite',
          abbreviation: 'ow',
          canBeNegated: false,
      ...
      DartedFlag(
          ...
          describtion: 'generate a log file `visited_files.txt`.'),
    ],
  ...
  DartedCommand(
    ...
    arguments: [
      ...
      DartedArgument(
          ...
          defaultValue: 'en',
          optionsSeparator: ',',
          describtion: 'languages to generate the json files for.'),
      DartedArgument(
          name: 'main-language',
          abbreviation: 'm',
          isMultiOption: false,
    ...
    flags: [
      ...
      DartedFlag(
          ...
          canBeNegated: false,
          appliedByDefault: true,
          describtion: 'wheather to genrate the json language files or not.'),
    ],
